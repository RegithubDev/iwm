<html class="loaded light-layout" lang="en" data-textdirection="ltr" style="--vh: 3.54px;"><!-- BEGIN: Head--><!-- Mirrored from pixinvent.com/demo/vuexy-html-bootstrap-admin-template/html/ltr/vertical-menu-template/table-datatable-basic.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 07 Aug 2022 05:42:05 GMT --><head>
    ...
    <meta name="viewport" content="width=device-width,initial-scale=1.0,site-scalable=0,minimal-ui">
...
">
            ...
            <a type="button" class="btn btn-gradient-danger re-text-bg" onclick="getSiteList();"><i data-feather='search'></i> Filter </a>
...
<div class="col-12" id="bigDiv">
								...
								<div >
									<div class="card-header border-bottom p-1">
										<div class="head-label">
											<h6 class="mb-0"><svg class="MuiSvgIcon-root MuiSvgIcon-fontSizeMedium svglogo css-vubbuv" focusable="false" aria-hidden="true" viewBox="0 0 24 24" data-testid="SupervisorAccountOutlinedIcon"><path d="M9 12c1.93 0 3.5-1.57 3.5-3.5S10.93 5 9 5 5.5 6.57 5.5 8.5 7.07 12 9 12zm0-5c.83 0 1.5.67 1.5 1.5S9.83 10 9 10s-1.5-.67-1.5-1.5S8.17 7 9 7zm.05 10H4.77c.99-.5 2.7-1 4.23-1 .11 0 .23.01.34.01.34-.73.93-1.33 1.64-1.81-.73-.13-1.42-.2-1.98-.2-2.34 0-7 1.17-7 3.5V19h7v-1.5c0-.17.02-.34.05-.5zm7.45-2.5c-1.84 0-5.5 1.01-5.5 3V19h11v-1.5c0-1.99-3.66-3-5.5-3zm1.21-1.82c.76-.43 1.29-1.24 1.29-2.18C19 9.12 17.88 8 16.5 8S14 9.12 14 10.5c0 .94.53 1.75 1.29 2.18.36.2.77.32 1.21.32s.85-.12 1.21-.32z"></path></svg> Sites</h6>
										</div>
										<div>
											<div class="dt-buttons d-inline-flex">
											 <a href="<%=request.getContextPath() %>/iris-addsite" type="button" class="btn btn-gradient-danger re-text-bg m-1"><i data-feather='site-plus'></i> Add New Site</a> 
										
					  </div>
					 </div>
					</div>
					 <table id="datatable-site" class="invoice-list-table table">
				            <thead>
				              <tr>
				                <th >#</th>
								<th >Actions</th>
    ...
    <div class="sidenav-overlay" style="touch-action: pan-y; site-select: none; -webkit-site-drag: none; -webkit-tap-highlight-color: rgba(0, 0, 0, 0);"></div>
    <div class="drag-target" style="touch-action: pan-y; site-select: none; -webkit-site-drag: none; -webkit-tap-highlight-color: rgba(0, 0, 0, 0);"></div>
				...
				.DataTable(
						{
							...
							"initComplete" : function() {
								...
								rowLen = $('#datatable-site tbody tr:visible').length
		        	 ...
		        	 { "mData": function(data,type,row){
                      if($.trim(data.state) == ''){ return '-'; }else{ return i++ ; }
						...
						{ "mData": function(data,type,row){
			                ...
			                +' <a href="javascript:void(0);"  onclick="getSite('+site_data+');" class="btn bghover re-text btn-outline-primary waves-effect"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-edit"><path d="M11 4H4a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7"></path><path d="M18.5 2.5a2.121 2.121 0 0 1 3 3L12 15l-4 1 1-4 9.5-9.5z"></path></svg></a>'
                
/* 			                +' <a onclick="deleteSite('+site_data+');" class="btn bghover re-text btn-outline-primary waves-effect"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-trash-2"><polyline points="3 6 5 6 21 6"></polyline><path d="M19 6v14a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V6m3 0V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2"></path><line x1="10" y1="11" x2="10" y2="17"></line><line x1="14" y1="11" x2="14" y2="17"></line></svg></a>'
 */              
			                +'</div>'
		            	return actions;
		            } },
		            { "mData": function(data,type,row){
                      if($.trim(data.sbu_code) == ''){ return '-'; }else{ return 'Re'+data.sbu_code ; }
		            } },
		         	{ "mData": function(data,type,row){
